...
//! Define __IRR_COMPILE_WITH_ZIP_ARCHIVE_LOADER_ if you want to initialize ZIP and GZIP archives
...
#endif
//! Define __IRR_COMPILE_WITH_PAK_ARCHIVE_LOADER_ if you want to initialize ID software PAK archives
...
#endif
//! Define __IRR_COMPILE_WITH_NPK_ARCHIVE_LOADER_ if you want to initialize Nebula Device NPK archives
...
#endif
//! Define __IRR_COMPILE_WITH_TAR_ARCHIVE_LOADER_ if you want to initialize TAR archives
...
#endif
//! Define __IRR_COMPILE_WITH_WAD_ARCHIVE_LOADER_ if you want to initialize WAD archives
